...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlLegSetCouponPricer(
        const ANY &ObjectId,
    ...
    try {
        ...
        OH_GET_OBJECT(ObjectIdObjPtr, ObjectIdCpp, QuantLibAddin::Leg)

        OH_GET_OBJECT(FloatingRateCouponPricerObjPtr, FloatingRateCouponPricerCpp, QuantLibAddin::FloatingRateCouponPricer)
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlLegSetCouponPricer: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
