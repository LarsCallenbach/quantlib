...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlFuturesRateHelper(
    ...
    try {
        ...
        ObjectHandler::property_t IMMCpp;
        calcToScalar(IMMCpp, IMM);
        ...
        QuantLib::Date IMMLib;
        calcToScalar(IMMLib, IMM);
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlFuturesRateHelperConvexityAdjustment(
        const ANY &ObjectId,
    ...
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlFuturesRateHelperConvexityAdjustment: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlSwapRateHelperForwardStart(
        const ANY &ObjectId,
        const ANY &Trigger) throw(RuntimeException) {
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlSwapRateHelperForwardStart: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlSwapRateHelperSpread(
        const ANY &ObjectId,
        const ANY &Trigger) throw(RuntimeException) {
    try {
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlSwapRateHelperSpread: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
...
SEQSEQ(ANY) SAL_CALL CalcAddins_impl::qlTenorSwapRateHelper(
        const ANY &ObjectId,
        const ANY &Rate,
        const ANY &Tenor,
        const ANY &Calendar,
    ...
    try {
        ...
        boost::shared_ptr<ObjectHandler::ValueObject> valueObject(
            new QuantLibAddin::ValueObjects::qlTenorSwapRateHelper(
                ObjectIdCpp,
                RateCpp,
                TenorCpp,
                CalendarCpp,
        ...
        boost::shared_ptr<ObjectHandler::Object> object(
            new QuantLibAddin::TenorSwapRateHelper(
                valueObject,
                RateLibObj,
                TenorLib,
                CalendarEnum,
        ...
        do { 
            std::ostringstream errorMsg; 
            errorMsg << "ERROR: qlTenorSwapRateHelper: " << e.what(); 
            OH_LOG_MESSAGE(errorMsg.str());
