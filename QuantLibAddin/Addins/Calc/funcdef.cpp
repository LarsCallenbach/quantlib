...
CalcAddins_impl::CalcAddins_impl() throw ()  {
    ...
    funcMap[ STRFROMANSI( "qlCalendarAdvance" ) ]
        =  STRFROMANSI( "qlCalendarAdvance" );
    funcDesc[ STRFROMANSI( "qlCalendarAdvance" ) ]
        =  STRFROMANSI( "advances a date according to a given calendar." );
    argName[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "calendar" ) );
    argDesc[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "ID of Enumeration of class QuantLib::Calendar" ) );
    argName[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "StartDate" ) );
    argDesc[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "start date to be advanced." ) );
    argName[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "Period" ) );
    argDesc[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "period(s) to advance (e.g. 2D for two days , 3W for three weeks, 6M for six months, 1Y for one year)." ) );
    argName[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "BusinessDayConvention" ) );
    argDesc[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "rolling convention. Default value = Following." ) );
    argName[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "EndOfMonth" ) );
    argDesc[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "flag to enforce end of month convention. Default value = false." ) );
    argName[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlCalendarAdvance" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    ...
    // qlLegSetCouponPricer

    funcMap[ STRFROMANSI( "qlLegSetCouponPricer" ) ]
        =  STRFROMANSI( "qlLegSetCouponPricer" );
    funcDesc[ STRFROMANSI( "qlLegSetCouponPricer" ) ]
        =  STRFROMANSI( "Set the coupon pricer at the given Leg object." );
    argName[ STRFROMANSI( "qlLegSetCouponPricer" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlLegSetCouponPricer" ) ].push_back( STRFROMANSI( "id of existing QuantLibAddin::Leg object" ) );
    argName[ STRFROMANSI( "qlLegSetCouponPricer" ) ].push_back( STRFROMANSI( "FloatingRateCouponPricer" ) );
    argDesc[ STRFROMANSI( "qlLegSetCouponPricer" ) ].push_back( STRFROMANSI( "FloatingRate coupon pricer object ID." ) );
    argName[ STRFROMANSI( "qlLegSetCouponPricer" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlLegSetCouponPricer" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    ...
    argDesc[ STRFROMANSI( "qlSimpleQuoteSetValue" ) ].push_back( STRFROMANSI( "id of existing QuantLib::SimpleQuote object" ) );
    ...
    argName[ STRFROMANSI( "qlFuturesRateHelper" ) ].push_back( STRFROMANSI( "IMM" ) );
    argDesc[ STRFROMANSI( "qlFuturesRateHelper" ) ].push_back( STRFROMANSI( "IMM date (or code)." ) );
    ...
    argName[ STRFROMANSI( "qlFuturesRateHelper2" ) ].push_back( STRFROMANSI( "IMM" ) );
    argDesc[ STRFROMANSI( "qlFuturesRateHelper2" ) ].push_back( STRFROMANSI( "IMM date (or code)." ) );
    ...
    argName[ STRFROMANSI( "qlFuturesRateHelper3" ) ].push_back( STRFROMANSI( "IMM" ) );
    argDesc[ STRFROMANSI( "qlFuturesRateHelper3" ) ].push_back( STRFROMANSI( "IMM date (or code)." ) );
    ...
    funcMap[ STRFROMANSI( "qlFuturesRateHelperConvexityAdjustment" ) ]
        =  STRFROMANSI( "qlFuturesRateHelperConvexityAdjustment" );
    funcDesc[ STRFROMANSI( "qlFuturesRateHelperConvexityAdjustment" ) ]
        =  STRFROMANSI( "returns the convexity adjustment for the given FuturesRateHelper object." );
    argName[ STRFROMANSI( "qlFuturesRateHelperConvexityAdjustment" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlFuturesRateHelperConvexityAdjustment" ) ].push_back( STRFROMANSI( "id of existing QuantLib::FuturesRateHelper object" ) );
    argName[ STRFROMANSI( "qlFuturesRateHelperConvexityAdjustment" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlFuturesRateHelperConvexityAdjustment" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    ...
    funcMap[ STRFROMANSI( "qlSwapRateHelperForwardStart" ) ]
        =  STRFROMANSI( "qlSwapRateHelperForwardStart" );
    funcDesc[ STRFROMANSI( "qlSwapRateHelperForwardStart" ) ]
        =  STRFROMANSI( "returns the forward start period for the given SwapRateHelper object." );
    argName[ STRFROMANSI( "qlSwapRateHelperForwardStart" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlSwapRateHelperForwardStart" ) ].push_back( STRFROMANSI( "id of existing QuantLib::SwapRateHelper object" ) );
    argName[ STRFROMANSI( "qlSwapRateHelperForwardStart" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlSwapRateHelperForwardStart" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
    ...
    // qlSequenceStatisticsIncMean

    funcMap[ STRFROMANSI( "qlSequenceStatisticsIncMean" ) ]
        =  STRFROMANSI( "qlSequenceStatisticsIncMean" );
    funcDesc[ STRFROMANSI( "qlSequenceStatisticsIncMean" ) ]
        =  STRFROMANSI( "Returns the mean for the given SequenceStatistics object." );
    argName[ STRFROMANSI( "qlSequenceStatisticsIncMean" ) ].push_back( STRFROMANSI( "ObjectId" ) );
    argDesc[ STRFROMANSI( "qlSequenceStatisticsIncMean" ) ].push_back( STRFROMANSI( "id of existing QuantLib::SequenceStatisticsInc object" ) );
    argName[ STRFROMANSI( "qlSequenceStatisticsIncMean" ) ].push_back( STRFROMANSI( "Trigger" ) );
    argDesc[ STRFROMANSI( "qlSequenceStatisticsIncMean" ) ].push_back( STRFROMANSI( "dependency tracking trigger" ) );
